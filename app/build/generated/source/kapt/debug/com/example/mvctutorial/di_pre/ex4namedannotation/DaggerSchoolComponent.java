...
public final class DaggerSchoolComponent implements SchoolComponent {
  ...
  private Student injectStudent2(Student instance) {
    Student_MembersInjector.injectName(instance, PersonModule_ProvidesStudentNameFactory.providesStudentName(personModule));
    return instance;
  }

  private Teacher injectTeacher2(Teacher instance) {
    Teacher_MembersInjector.injectName(instance, PersonModule_ProvidesTeacherNameFactory.providesTeacherName(personModule));
    return instance;
  }
